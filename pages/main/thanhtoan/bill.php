        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
			...
			<div class="row">
				<div class="receipt-header receipt-header-mid">
					<div class="col-xs-8 col-sm-8 col-md-8 text-left">
						<div class="receipt-right">
							<h5><?php echo $row_ship[1]?> </h5>
							<p><b>Mobile : </b><?php echo $row_ship[2]?></p>
							<p><b>Address : </b> <?php echo $row_ship[3]?></p>
							<p><b>Note : </b> <?php echo $row_ship[4]?></p>
						</div>
					</div>
            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><h3 style="text-align: center;"><?php echo $row_cart[5]?></h3></td>
                            <td class="col-md-9"><h3 style="text-align: center;"><?php echo $row_cart[4]?></h3></td>
                            <td class="col-md-9"><h3 style="text-align: center;"><?php echo $row_cart[6]?><sub class="d">đ</sub></h3></td>
                        </tr>
                        <tr>
                            <td class="text-right">
                            <p>
                        ...
                        <tr>
                            ...
                            <td class="text-left text-danger"><h2><strong><i class="fa fa-inr"></i> <?php echo $row_cart[4] * $row_cart[6] + 15000?><sub class="d">đ</sub></strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
